  ...
  sketch = (p5) => {
    ...
    p5.setup = (canvasParentRef) => {
      ...
      infrastructurePath = [
        ...
        { moveTo: { x: this.props.phone.x + this.props.phone.w / 2, y: this.props.phone.y - 250 } },
    ...
    p5.draw = () => {
      ...
      drawInfrastructureNodes(p5, this.props.phone, boldFont, regularFont, infrastructurePath, cellTowerPingColor, this.props.httpSignal, createIP, clientIP, generateIP, toIP, fromIP, website, requestData, this.props.setDNSHover, this.props.pinged, this.props.setPing, hovering, setHovering, this.props.hoverElement, possibleHovers);
      drawSignalVisualization(p5, boldFont, regularFont, this.props.phone, this.props.httpSignal, httpSignalPos, previousSignalEndpoint, drawSignal, reverseSignal, turtle, turtlePath, originalTurtlePath, drawTurtle, turtleReverse, turtleColor, turtleColors, cellTowerPingColor, routers, routerTurtle, routerMovements, createIP, pathFullyCompleted, this.props.pinged, this.props.setPing, hovering, setHovering, this.props.hoverElement, possibleHovers);
      ...
      drawInternetSpeed(p5, boldFont, regularFont, internetSpeed, speeds, canChangeSpeed, possibleSpeeds, turtle, routerTurtle, httpSignalPos);
