export default function drawRouters(p5, routers) {
    ...
    gradientLine(routers[1].entrancePoint.x, routers[1].entrancePoint.y, routers[1].entrancePoint.x, routers[1].entrancePoint.y - 75);
    gradientLine(routers[2].entrancePoint.x, routers[2].entrancePoint.y, routers[2].entrancePoint.x - 75, routers[2].entrancePoint.y - 75);
    gradientLine(routers[3].entrancePoint.x, routers[3].entrancePoint.y, routers[3].entrancePoint.x - 100, routers[3].entrancePoint.y);
    gradientLine(routers[13].entrancePoint.x, routers[13].entrancePoint.y, routers[13].entrancePoint.x - 75, routers[13].entrancePoint.y);
    gradientLine(routers[15].entrancePoint.x, routers[15].entrancePoint.y, routers[15].entrancePoint.x - 65, routers[15].entrancePoint.y + 65);
    gradientLine(routers[22].entrancePoint.x, routers[22].entrancePoint.y, routers[22].entrancePoint.x, routers[22].entrancePoint.y + 65);
    gradientLine(routers[23].entrancePoint.x, routers[23].entrancePoint.y, routers[23].entrancePoint.x, routers[23].entrancePoint.y + 125);
    gradientLine(routers[24].entrancePoint.x, routers[24].entrancePoint.y, routers[24].entrancePoint.x, routers[24].entrancePoint.y - 75);
    gradientLine(routers[28].entrancePoint.x, routers[28].entrancePoint.y, routers[28].entrancePoint.x + 65, routers[28].entrancePoint.y + 65);
    gradientLine(routers[29].entrancePoint.x, routers[29].entrancePoint.y, routers[29].entrancePoint.x + 75, routers[29].entrancePoint.y);
    gradientLine(routers[30].entrancePoint.x, routers[30].entrancePoint.y, routers[30].entrancePoint.x + 75, routers[30].entrancePoint.y);
    gradientLine(routers[31].entrancePoint.x, routers[31].entrancePoint.y, routers[31].entrancePoint.x + 95, routers[31].entrancePoint.y - 140);
    
    // Draw Lines  
    p5.drawingContext.strokeStyle = "black";    
